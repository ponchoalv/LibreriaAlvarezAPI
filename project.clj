(defproject libreria "0.1.0-SNAPSHOT"
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "libreria.core/mount-components"}
                     :compiler
                     {:main "libreria.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
